...
env -u GPUMDkit_path gpumdkit -skill | grep -F "${PREFIX}/share/gpumdkit/skills/gpumdkit-skill" >/dev/null
...
env -u GPUMDkit_path gpumdkit -update | grep -F "conda update gpumdkit" >/dev/null
