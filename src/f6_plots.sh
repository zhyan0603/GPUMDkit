...
function f6_plots_one_column(){
    ...
    echo " |  sigma_PT       Plot phase-transition Arrhenius sigma   |"
    echo " |  D_PT           Plot phase-transition Arrhenius D       |"
    ...
    echo " |  xrd            Plot X-ray diffraction                  |"
    echo " |  xrd_comp       Compare XRD                             |"
    ...
    echo " |  emd2           Plot EMD results in all directions      |"
    ...
    echo " |  phonon         Plot phonon band structure              |"
...
function f6_plots_two_column(){
    ...
    echo " |  des            - Descriptors                    net_force      - Net force distribution      |"
    echo " +-----------------------------------------------------------------------------------------------+"
    echo " |                                     Diffusion & Transport                                     |"
    echo " +-----------------------------------------------------------------------------------------------+"
    ...
    echo " |  msd_sdc        - MSD and SDC together           doas           - Density of atomistic states |"
    echo " |  D              - Arrhenius diffusivity          sigma          - Arrhenius ionic conductivity|"
    echo " |  D_xyz          - Directional Arrhenius D        sigma_xyz      - Directional Arrhenius sigma |"
    echo " |  D_PT           - PT Arrhenius D                 sigma_PT       - PT Arrhenius sigma          |"
    echo " +-----------------------------------------------------------------------------------------------+"
    echo " |                                    MD & Structural Analysis                                   |"
    echo " +-----------------------------------------------------------------------------------------------+"
    ...
    echo " |  xrd            - X-ray diffraction              plane-grid     - Displacement plane grid     |"
    echo " |  xrd_comp       - Compare XRD                                                                 |"
    echo " +-----------------------------------------------------------------------------------------------+"
    echo " |                                        Heat Transport                                         |"
    echo " +-----------------------------------------------------------------------------------------------+"
    echo " |  emd            - EMD results                    emd2           - EMD all directions          |"
    echo " |  nemd           - NEMD results                   hnemd          - HNEMD results               |"
