<div align="center">
  <h1>🤝 为 GPUMDkit 贡献代码</h1>
  <p style="text-align: justify;">感谢你有兴趣为 <strong>GPUMDkit</strong> 做出贡献！我们感谢你为改善这个工具包所付出的时间和努力。</p>
</div>

<p align="center">
  <a href="../en/contributing_to_gpumdkit.md">English</a>
  &nbsp;·&nbsp;
  <strong>简体中文</strong>
</p>

`GPUMDkit` 是一个开源项目，我们欢迎社区的各种贡献，无论是修复 bug、添加新功能、改进文档还是提出建议。

> **注意**：本文档的权威版本位于仓库根目录的 [`CONTRIBUTING.md`](https://github.com/zhyan0603/GPUMDkit/blob/main/CONTRIBUTING.md)。本教程页面同步其内容。中文版请参见 [`docs/CONTRIBUTING_zh-CN.md`](https://github.com/zhyan0603/GPUMDkit/blob/main/docs/CONTRIBUTING_zh-CN.md)。
