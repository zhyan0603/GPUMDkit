...
- `plt_doas.py`: Python script to plot the *density of atomistic states* (DOAS) proposed by [Wang et al](https://doi.org/10.1002/anie.202215544).
  ...
  <div align="center">
      <img src="../../docs/Gallery/doas.png" alt="dimer" width="55%" />
  </div>



`thermo.png`, `train.png`, `train_test.png`, `prediction.png`, `msd.png`, `msd_all.png`, `msd_convergence.png`, `nep_restart.png`, `rdf.png`, `dimer.png`, `charge.png`,`doas.png`: Example output plots generated by the scripts.
...
```bash
gpumdkit.sh -plt thermo/train/prediction/train_test/msd/msd_all/msd_conv/sdc/rdf/vac/restart/dimer/des/charge/lr/doas/parity_density [save]
```
