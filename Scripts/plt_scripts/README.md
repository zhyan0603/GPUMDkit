...
The plotter reads the second numeric column as the angle and the fourth
numeric column as the intensity.
...
**Column mapping:** The second numeric column (column index 1) is the angle,
and the fourth numeric column (column index 3) is the intensity. Lines beginning
